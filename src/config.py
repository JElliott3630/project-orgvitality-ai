...
# --- Data Paths ---
# Centralize all data-related paths for easy access and management
...
# --- Source File Paths ---
# Define paths for raw input files to be processed
...
# Define paths for storing the output of ingestion and normalization scripts
...
PROCESSED_JSON = os.path.join(PROCESSED_DATA_DIR, "all_chunks_normalized.json")

# --- Source Names ---
# Standardize source names to ensure consistency across the application
SOURCE_NAMES = {
...
# Define the path for the YAML file containing all prompts
PROMPT_PATH = os.path.join(PROJ_ROOT, "src", "prompts.yml")

# --- Evaluation Data ---
# Define the path for the evaluation questions CSV file
